...
public class SuperstructureState {
    ...
    public static SuperstructureState kInvalidState =
            new SuperstructureState(Degree.of(-100), Meters.of(-1));
    public static SuperstructureState troughScore =
            new SuperstructureState(PivotConstants.kLevel1Angle, ElevatorConstants.kLevel1Height);
    public static SuperstructureState lowScore =
            new SuperstructureState(PivotConstants.kLevel2Angle, ElevatorConstants.kLevel2Height);
    public static SuperstructureState midScore =
            new SuperstructureState(PivotConstants.kLevel3Angle, ElevatorConstants.kLevel3Height);
    public static SuperstructureState highScore =
            new SuperstructureState(PivotConstants.kLevel4Angle, ElevatorConstants.kLevel4Height);
