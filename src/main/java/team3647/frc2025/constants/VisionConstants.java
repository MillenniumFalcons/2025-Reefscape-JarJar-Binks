...
public class VisionConstants {
	public static final AprilTagFieldLayout k2025AprilTags = AprilTagFieldLayout
	...
	public static final Transform3d BackLeft = new Transform3d(
			Inches.of(-2.87203),
			Inches.of(8.35946),
			Inches.of(28.72351),
			new Rotation3d(Degrees.of(11.797), Degrees.of(10), Degrees.of(65)));
	public static final Transform3d FrontLL = new Transform3d(
			Inches.of(12.75),
			Inches.of(0),
			Inches.of(1.5),
